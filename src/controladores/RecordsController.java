...
public class RecordsController {
	...
	public boolean insertarJugador(int id, String nombre, String contrasena, String email, String tiempo) {
		...
		if (existeJugador(id)) {
			...
			JOptionPane.showMessageDialog(null, "El jugador con el ID especificado ya existe.", "Jugador existente",
					JOptionPane.WARNING_MESSAGE);
			return false; // El ID ya existe en la base de datos
		}

		String insertQuery = "INSERT INTO jugadores (idJugador, nombre, contrasena, email, tiempo) " + "VALUES (" + id
				+ ", '" + nombre + "', '" + contrasena + "', '" + email + "', '" + tiempo + "')";
	...
	// Método para verificar si un jugador con el ID especificado existe en la base
	// de datos
	...
	/**
	 * Obtiene un modelo de tabla con los datos de los jugadores desde la base de
	 * datos.
	 * 
