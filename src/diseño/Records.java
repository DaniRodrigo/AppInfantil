	...
	public Records() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (textid.getText().isEmpty() || textnombre.getText().isEmpty() || textcontrasena.getText().isEmpty()
						|| textemail.getText().isEmpty() || texttiempo.getText().isEmpty()) {
					// Muestra un mensaje de error o realiza alguna acción apropiada
					JOptionPane.showMessageDialog(null,
							"Por favor, complete todos los campos antes de insertar un nuevo registro.",
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (idText.isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Por favor, ingrese un ID válido para eliminar un registro.",
							"ID vacío", JOptionPane.WARNING_MESSAGE);
				} else {
					try {
						...
						if (deleted) {
							...
							JOptionPane.showMessageDialog(null, "Hubo un error en la eliminación o el ID no existe.",
									"Error al eliminar", JOptionPane.ERROR_MESSAGE);
						}
					} catch (NumberFormatException ex) {
						// Muestra un mensaje de error si el campo "id" no es un número válido
						JOptionPane.showMessageDialog(null, "El campo ID no es un número válido.", "ID inválido",
		...
		// Crea una instancia de tu modelo de tabla personalizado y pásale los datos de
		// la base de datos
